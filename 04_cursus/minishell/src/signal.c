...
// /*                                                +#+#+#+#+#+   +#+           */
// /*   Created: 2024/05/09 12:06:30 by zkepes            #+#    #+#             */
// /*   Updated: 2024/05/09 12:56:44 by zkepes           ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */

// #include "../include/minishell.h"

// // for more information see https://www.codequoi.com/en/sending-and-intercepting-a-signal-in-c/
...
// // sigprocmask(SIG_BLOCK, &sigset, NULL); // can not use function because of subject
// 	if (signal == SIGQUIT)
